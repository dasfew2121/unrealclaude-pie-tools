...
// PIE testing and virtual input tools
#include "Tools/MCPTool_PIEControl.h"
#include "Tools/MCPTool_VirtualInput.h"
#include "Tools/MCPTool_PlayerControl.h"
#include "Tools/MCPTool_TimelapseCapture.h"
...
void FMCPToolRegistry::RegisterBuiltinTools()
{
	...
	// PIE testing and virtual input tools
	RegisterTool(MakeShared<FMCPTool_PIEControl>());
	RegisterTool(MakeShared<FMCPTool_VirtualInput>());
	RegisterTool(MakeShared<FMCPTool_PlayerControl>());
	RegisterTool(MakeShared<FMCPTool_TimelapseCapture>());
